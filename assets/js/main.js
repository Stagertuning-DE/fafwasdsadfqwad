...
/* ==========================================================================
   Stagertuning – Website Scripts
   --------------------------------------------------------------------------
   - Barrierearme Mobile‑Navigation
   - IntersectionObserver Reveal‑Effekte
   - FAQ‑Accordion
   - (Konfigurator‑Code entfernt, da kein Online‑Konfigurator) 
   ========================================================================== */
...
// Konfigurator‑Code entfernt: In dieser Version gibt es keinen Leistungsrechner.
...
// Hinweis: Der eigene Cookie-Banner wurde entfernt. Wenn der Cookie-Manager
// eingebunden ist, übernimmt dieser die Verwaltung der Einwilligungen.
